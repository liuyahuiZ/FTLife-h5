<template>
  <div class="main-home relative bg-show" id="home">
    <div class="main-home" :class="{ 'picture-screen zindex-200': showPicture=== true }">
      <div class="box-flex relative flex-direction-column zindex-10"  :class="{ 'p1-pic-animate': line1Animate, 'opacity-0':!line1Animate }">
          <div class="bg-00A1E4-r width-65 margin-top-5r textclolor-white padding-1m font-size-12" :class="{ 'padding-1m': showPicture=== true }">
              <div class="line-heightr-2" :class="{ 'font-size-9': showPicture=== true , 'p1-pic-animate': line2Animate, 'opacity-0':!line2Animate}">我的盛世</div>
              <div :class="{ 'font-size-7': showPicture=== true, 'font-size-8': showPicture=== false, 'p1-pic-animate': line3Animate, 'opacity-0':!line3Animate   }">
                <span v-show="fontType==='jian'">是镜子里的那个小大人</span>
                <span v-show="fontType==='fan'">是知道鏡子裡的那個小大人</span>
              </div>
              <div :class="{ 'font-size-7': showPicture=== true, 'font-size-8': showPicture=== false , 'p1-pic-animate': line4Animate, 'opacity-0':!line4Animate}">
    ...
    <img src="../Img/page3_bg.jpg" class="absolute width-100 top-0 zindex-9"/>
    <music ref="audio" />
  </div>
</template>
